...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-6 relative">
      ...
      >
        <GlassCard className="w-full p-8" glow="cyan">
          {/* Lock icon */}
          <div className="flex justify-center mb-6">
            <div className="w-12 h-12 rounded-full glass-effect flex items-center justify-center glow-cyan">
              <svg
          ...
          <h1 className="font-display font-bold text-2xl text-foreground text-center mb-1 text-glow">
            Admin Portal
          </h1>
