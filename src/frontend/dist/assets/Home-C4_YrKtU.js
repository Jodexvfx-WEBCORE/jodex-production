import { r as reactExports, j as jsxRuntimeExports, R as React, a as reactDomExports, b as ReactDOM, c as cn } from "./index-HTiSLxfL.js";
import { f as frame, c as cancelFrame, i as interpolate, s as supportsViewTimeline, a as supportsScrollTimeline, p as progress, v as velocityPerSecond, b as isHTMLElement, d as defaultOffset$1, e as clamp, n as noop, r as resize, g as frameData, u as useConstant, h as useIsomorphicLayoutEffect$1, j as invariant, m as motionValue, M as MotionConfigContext, k as collectMotionValues, l as motion } from "./proxy-DSs8VgC6.js";
...
const HINDI_COMMENTS = {
  cLoXQb5M6oI: "The editing was absolutely fire — our channel views shot up after this!",
  nWc3c1Lvp1Q: "Everyone loved it! The work turned out incredible, really exceeded expectations.",
  OX5vqtiZQ2s: "The 3D animation was so smooth, it genuinely made me smile watching it.",
  LJxoLJ_5uyQ: "Timing and transitions were spot on — exactly what we had in mind.",
  jqgYlRHfyQU: "The overall video quality looks super high-end. Really impressive work.",
  mr_O1xgobE8: "Jodex delivered something beyond words — absolutely superb output!",
  "6NbGjuKwvYA": "The audio-visual combo was outstanding, our audience loved every second.",
  _sXXPXnJuBg: "Fast delivery and such clean editing — this is genuinely professional work.",
  "4rHYfFW3Edc": "Better than we expected — it had a real cinematic feel to it.",
  jBzR16cQEh4: "Colors, text, and music all came together perfectly. We're very happy!",
  f1X5QWwrwN8: "The interior visualization left our client speechless — outstanding work!"
};
...
function YTLogo({ size = 22 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      role: "img",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width: "90", height: "63", rx: "13", fill: "#FF0000" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M37 20 L37 43 L58 31.5 Z", fill: "white" })
      ]
    }
  );
}
function YouTubeCard({ video }) {
  ...
  const [oEmbed, setOEmbed] = reactExports.useState(null);
  const [thumbError, setThumbError] = reactExports.useState(false);
  const [loading, setLoading] = reactExports.useState(true);
  const videoId = extractVideoId(video.url);
  const maxresThumbnail = videoId ? `https://img.youtube.com/vi/${videoId}/maxresdefault.jpg` : null;
  const hqThumbnail = videoId ? `https://img.youtube.com/vi/${videoId}/hqdefault.jpg` : null;
  ...
  reactExports.useEffect(() => {
    ...
    let cancelled = false;
    setLoading(true);
    const cleanUrl = videoId ? `https://www.youtube.com/watch?v=${videoId}` : video.url;
    const encoded = encodeURIComponent(cleanUrl);
    fetch(`https://www.youtube.com/oembed?url=${encoded}&format=json`).then((r) => {
  ...
  const handleMouseMove = (e) => {
    ...
    card.style.boxShadow = "0 8px 48px rgba(0,0,0,0.6), 0 0 28px rgba(0,217,255,0.45)";
  };
  const handleMouseLeave = () => {
    const card = cardRef.current;
    if (!card) return;
    card.style.transform = "perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1,1,1)";
    card.style.boxShadow = "0 4px 32px rgba(0,0,0,0.5), 0 0 0px rgba(0,217,255,0)";
  };
  const handleClick = () => {
    window.open(video.url, "_blank", "noopener,noreferrer");
  };
  const channelName = (oEmbed == null ? void 0 : oEmbed.author_name) ?? null;
  const displayTitle = (oEmbed == null ? void 0 : oEmbed.title) ?? video.title;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ref: cardRef,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full aspect-video overflow-hidden bg-black/60 flex-shrink-0", children: [
          loading ? (
            /* Skeleton */
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full bg-white/5 animate-pulse" })
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(YTLogo, { size: 48 }) }),
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(YTLogo, { size: 20 }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-0 flex-1", children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-3 w-24 bg-white/10 rounded animate-pulse" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-sm font-medium truncate block leading-tight", children: channelName ?? "YouTube" }) })
              ] }),
              loading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 mt-0.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2.5 w-full bg-white/10 rounded animate-pulse" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2.5 w-3/4 bg-white/10 rounded animate-pulse" })
              ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
              ...
              !loading && hindiComment && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
...
function ClientWorkSection({ videos }) {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "radial-gradient(ellipse 80% 50% at 50% 100%, oklch(0.12 0.04 200 / 0.5) 0%, transparent 70%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
          ...
          displayVideos.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-foreground/40 text-base tracking-wide", children: "No client work added yet" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs mt-2 opacity-30 tracking-wider", children: "Videos will appear here once added from the admin panel" })
              ]
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: displayVideos.map((video, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(YouTubeCard, { video })
            },
            video.id
          )) })
        ] })
...
function PanelMedia({ entry, index }) {
...
function HeroPanelCarousel() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: PANEL_STYLES }),
    panels.map((entry, i) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: {
            ...
            boxShadow: "0 4px 24px rgba(0,0,0,0.4), 0 0 6px rgba(0,217,255,0.06)",
            animation: `${anim.name} ${anim.duration} ease-in-out ${anim.delay} infinite`,
            willChange: "transform"
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PanelMedia, { entry, index: i }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
...
const CONTACT_OPTIONS = [
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        ...
        role: "img",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width: "24", height: "24", rx: "5", fill: "rgba(255,80,80,0.18)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "path",
            {
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        ...
        role: "img",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width: "24", height: "24", rx: "5", fill: "rgba(88,101,242,0.18)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "path",
            {
...
function Home() {
  ...
  const [videos, setVideos] = reactExports.useState(loadVideosFromStorage);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: containerRef, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { className: "absolute inset-0 -z-10", style: { y: bgY }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "w-full h-full",
              style: {
                background: "radial-gradient(ellipse 85% 65% at 50% 42%, oklch(0.14 0.05 200 / 0.85) 0%, oklch(0.06 0 0) 68%)"
              }
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(HeroPanelCarousel, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-20 flex flex-col items-center text-center px-6 pt-24 pb-16 w-full max-w-5xl mx-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.h1,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.p,
              {
                ...
                children: "3D Animation  |  2D Animation  |  Video Editing  |  Interior Designing"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.p,
              {
                ...
                children: '"Chill vibe matters only..."'
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    style: {
                      background: "linear-gradient(135deg, rgba(255,0,255,0.22) 0%, rgba(180,0,180,0.12) 100%)",
                      border: "1px solid rgba(255,0,255,0.55)",
                      boxShadow: "0 0 18px rgba(255,0,255,0.28), inset 0 0 18px rgba(255,0,255,0.04)",
                      transition: "box-shadow 0.3s ease, transform 0.3s ease"
                    },
                    onMouseEnter: (e) => {
                      const el = e.currentTarget;
                      el.style.boxShadow = "0 0 40px rgba(255,0,255,0.7), inset 0 0 28px rgba(255,0,255,0.1)";
                      el.style.transform = "scale(1.06)";
                    },
                    onMouseLeave: (e) => {
                      const el = e.currentTarget;
                      el.style.boxShadow = "0 0 18px rgba(255,0,255,0.28), inset 0 0 18px rgba(255,0,255,0.04)";
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-10 bg-gradient-to-b from-transparent via-accent to-transparent" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ClientWorkSection, { videos }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: contactOpen, onOpenChange: setContactOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      DialogContent,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              ...
              boxShadow: "0 0 60px rgba(0,0,0,0.8), 0 0 30px rgba(0,217,255,0.07)"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { className: "px-7 pt-7 pb-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  DialogTitle,
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/40 font-body text-xs text-center tracking-widest uppercase mt-1", children: "Choose how to reach me" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3 px-7 pb-7", children: CONTACT_OPTIONS.map((opt, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.a,
                {
                  href: opt.href,
                  target: opt.target,
                  rel: opt.target === "_blank" ? "noopener noreferrer" : void 0,
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0", children: opt.icon }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex flex-col gap-0.5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
